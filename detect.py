...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='point_data/images/val', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--output', type=str, default='point_data/images/vel_detected_result', help='output folder')  # output folder
